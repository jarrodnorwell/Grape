...
uint32_t Cp15::read(int cn, int cm, int cp) {
    ...
    switch ((cn << 16) | (cm << 8) | (cp << 0)) {
        ...
        case 0x000001:
            return 0x0F0D2112; // Cache type
        case 0x010000:
            return ctrlReg;    // Control
        case 0x090100:
            return dtcmReg;    // Data TCM base/size
        case 0x090101:
            return itcmReg;    // Instruction TCM size
...
void Cp15::write(int cn, int cm, int cp, uint32_t value) {
    ...
    switch ((cn << 16) | (cm << 8) | (cp << 0)) {
        ...
        case 0x070004:
        case 0x070802: // Wait for interrupt
        {
