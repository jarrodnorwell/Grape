...
public:
    ...
    template<typename T>
    T read(bool cpu, uint32_t address);

    template<typename T>
    void write(bool cpu, uint32_t address, T value);
...
private:
    ...
    template<typename T>
    T readFallback(bool cpu, uint32_t address);

    template<typename T>
    void writeFallback(bool cpu, uint32_t address, T value);

    template<typename T>
    T ioRead9(uint32_t address);

    template<typename T>
    T ioRead7(uint32_t address);

    template<typename T>
    T ioReadGba(uint32_t address);

    template<typename T>
    void ioWrite9(uint32_t address, T value);

    template<typename T>
    void ioWrite7(uint32_t address, T value);

    template<typename T>
    void ioWriteGba(uint32_t address, T value);
...
template<typename T>
FORCE_INLINE T Memory::read(bool cpu, uint32_t address) {
    // Align the address
    address &= ~(sizeof(T) - 1);
...
template<typename T>
FORCE_INLINE void Memory::write(bool cpu, uint32_t address, T value) {
    // Align the address
    address &= ~(sizeof(T) - 1);
